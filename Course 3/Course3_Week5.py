...
# Actual data: http://py4e-data.dr-chuck.net/comments_43687.xml (Sum ends
#  with 91) You do not need to save these files to your folder since your
...
# The data consists of a number of names and comment counts in XML
# as follows:
#
# <comment>
#   <name>Matthias</name>
...
# different than the data we are parsing in that sample code you will have
...
# supported XPath syntax for details. You could also work from the top
# of the XML down to the comments node and then loop through the child nodes
